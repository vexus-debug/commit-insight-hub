    ...
    <PageTransition><div className="min-h-screen">
      ...
      <section className="py-20 bg-section-alt">
        <div className="container mx-auto px-4 text-center">
          <h1 className="font-heading text-4xl md:text-5xl font-bold text-section-alt-foreground mb-4">{p.title}</h1>
          <p className="text-section-alt-foreground/70">Last updated: {p.lastUpdated}</p>
        </div>
      </section>
